...
# 首次提交
git commit -m "Initial release: LeMingle v1.0.4

- Multi-language README (5 languages)
- Comprehensive installation guide
- User documentation
- Security policy
- Extension package v1.0.4"
...
2. **填写信息**：
   - **Tag**: `v1.0.4`
   - **Target**: `main`
   - **Title**: `LeMingle v1.0.4 - Multi-language Support`
   - **Description**: 复制 `RELEASE_TEMPLATE.md` 的内容

3. **上传文件**：
   - 拖拽 `lemingle-v1.0.4.zip` 到附件区域
